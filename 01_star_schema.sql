...
/* Optional: Add segment manually */
-- UPDATE dim_model SET segment='SUV' WHERE model_name IN ('X5','X6');
-- UPDATE dim_model SET segment='Sedan' WHERE model_name IN ('3 Series','5 Series');
-- UPDATE dim_model SET segment='EV' WHERE model_name IN ('i3','iX');
